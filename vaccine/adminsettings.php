    ...
    <?php require_once 'connections.php'; ?>
      ...
      <img src="https://media2.giphy.com/media/WUyeycaNusqDWv7KUz/giphy.gif?cid=6c09b9523c8491c796db8eb4a5354f50721bd859c8cc4124&rid=giphy.gif&ct=s" style="width:30%;">
        ...
        <input type = "text" name = "uname" class = "form-control"
              value = "<?php echo $uname; ?>" placeholder = "Update username">

        <button type = "submit" name = "update"> Save </button>        
        <a href="adminsignup.php" class="add" onclick="myFunction()">Add Account</a>
        
        <a href="adminchangepass.php" class="change">Change Password</a>
        <a href="adminprofile.php" class="cancel">Cancel</a>
