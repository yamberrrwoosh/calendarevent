...
function myFunction() {
  ...
  <?php
    ...
    $result = $mysqli->query("SELECT * FROM client where user_id = '$currentUser'") or die ($mysqli->error);
  ?>
  ...
  ?>
        ...
        <tr>
          <td>
            <a href = "usersettings.php?edit=<?php echo $row['id']; ?>"
            class = "btn btn-info"> Edit </a>
            <a href = "userlogin.php?delete=<?php echo $row['id']; ?>"
